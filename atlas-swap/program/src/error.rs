...
pub enum SwapError {
    ...
    /// The decimal validation error.(Decimal must be 8)
    #[error("The decimal validation error.(Decimal must be 8)")]
    MismatchDecimalValidation,

    /// invalid program derived address
    #[error("invalid program derived address")]
    InvalidPdaAddress,

    /// Invalid Dex Program Id
    #[error("Can't allocate space for the account")]
    InvalidAllocateSpaceForAccount,

    /// The account cannot be initialized because it is already being used.
    #[error("owner should be the signer")]
    InvalidSigner,
    ...
    /// The owner of the input isn't set to the program address generated by the program.
    #[error("Invalid owner of the contract")]
    InvalidProgramOwner,
